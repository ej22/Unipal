...
public class DatabaseSetup
{
	...
	public static final String[] allModules = { KEY_ID, KEY_SUBJECT,
			KEY_ABBREVIATION, KEY_COLOUR };
	...
	public static final String[] displayListViewAdapterEvents = { KEY_ID,
			KEY_NAME, KEY_SUBJECT, KEY_TYPE, KEY_DUE_DATE };
	public static final String[] allEventFields = { KEY_ID, KEY_NAME,
			KEY_SUBJECT, KEY_TYPE, KEY_SUBTYPE, KEY_DUE_DATE, KEY_DESC };

	public static final String KEY_EVENT_ID = "event_id";

	// Create Table Statements
	private static final String CREATE_MODULE_TABLE = "create table "
			+ TABLE_MODULE + " (" + KEY_ID
			+ " integer primary key autoincrement, " + KEY_SUBJECT
			+ " text not null, " + KEY_ABBREVIATION + " text,  " + KEY_COLOUR
			+ " int not null);";

	private static final String CREATE_TASK_TABLE = "create table "
			+ TABLE_EXAM + " (" + KEY_ID
			+ " integer primary key autoincrement, " + KEY_NAME
			+ " text not null, " + KEY_SUBJECT + " text not null, " + KEY_TYPE
			+ " text not null, " + KEY_SUBTYPE + " text, " + KEY_DUE_DATE
			+ " text not null, " + KEY_DESC + " text);";
	...
	public long insertExam(String name, String subject, String type,
			String subType, String date, String desc) {
	...
	public long insertTask(String name, String subject, String type,
			String subType, String date, String desc) {
		ContentValues initialValues = new ContentValues();
	...
	public Cursor getAllModules() {
		String where = null;
		Cursor c = db.query(true, TABLE_MODULE, allModules, where, null, null,
				null, null, null);
		if (c != null)
		{
			c.moveToFirst();
	...
	public Cursor getModuleDetails(long id) {
		...
		Cursor cursor = db.query(true, TABLE_MODULE, allModules, where, null,
				null, null, null, null);
	...
	public Cursor getExamDetails(long id) {
		String where = KEY_ID + "=" + id;
		Cursor cursor = db.query(true, TABLE_EXAM, allEventFields, where, null,
				null, null, null, null);
	...
	public Cursor getTaskDetails(long id) {
		String where = KEY_ID + "=" + id;
		Cursor cursor = db.query(true, TABLE_TASK, allEventFields, where, null,
				null, null, null, null);
	...
	public boolean updateModule(long id, String subject, String abbreviation,
			String color) {
	...
	public boolean updateTask(long id, String name, String subject,
			String type, String subType, String date, String desc) {
		ContentValues args = new ContentValues();
	...
	public boolean updateExam(long id, String name, String subject,
			String type, String subType, String date, String desc) {
		ContentValues args = new ContentValues();
		args.put(KEY_NAME, name);
		args.put(KEY_SUBJECT, subject);
